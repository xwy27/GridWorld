...
public final class ModifiedChameleonRunner {
    ...
    public static void main(String[] args) {
        ...
        world.add(new Location(Number.FOUR, Number.FOUR), new ModifiedChameleonCritter());
        world.add(new Location(Number.FIVE, Number.EIGHT), new ModifiedChameleonCritter());
        world.show();
    }
}