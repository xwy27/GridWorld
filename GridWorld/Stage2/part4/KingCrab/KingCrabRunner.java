...
/**
 * This class runs a world that king crab critters. <br />
 */
public final class KingCrabRunner {
    ...
    public static void main(String[] args) {
        ...
        world.add(new Location(Number.FOUR, Number.FOUR), new KingCrab());
        world.add(new Location(Number.FIVE, Number.EIGHT), new KingCrab());
        world.show();
    }
}